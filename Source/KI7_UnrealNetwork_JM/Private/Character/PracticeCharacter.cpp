...
void APracticeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//if (EnhancedInput)
	//{
	//	EnhancedInput->BindAction(IA_Key1, ETriggerEvent::Started, this, &APracticeCharacter::OnKey1);
	//	EnhancedInput->BindAction(IA_Key2, ETriggerEvent::Started, this, &APracticeCharacter::OnKey2);
	//	EnhancedInput->BindAction(IA_Key3, ETriggerEvent::Started, this, &APracticeCharacter::OnKey3);
	//}
}
